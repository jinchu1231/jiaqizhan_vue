        ...
        <div class="JNPF-common-layout-center">
          ...
          <div class="JNPF-common-layout-main JNPF-flex-main">
            <JNPF-table v-loading="listLoading" :data="list" :border="false" highlight-current-row
              ...
              <el-table-column prop="isQuote" label="是否引用" width="80" align="center"
                v-if="this.type==1">
                <template slot-scope="scope">
                  <el-tag :type="scope.row.isQuote ? 'danger' :'success'" disable-transitions>
                    {{scope.row.isQuote?'是':'否'}}</el-tag>
                </template>
              </el-table-column>
              <el-table-column prop="enCode" :label="label+'编码'" />
              <el-table-column prop="formType" :label="label+'类型'" width="80">
                <template slot-scope="scope">
