    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" :hasNO="false">
          ...
          <el-table-column prop="birthday" label="出生年月" sortable width="140"
            :formatter="jnpf.tableDateFormat" />
          <el-table-column prop="attendWorkTime" label="参加工作" sortable width="140"
            :formatter="jnpf.tableDateFormat" />
          ...
          <el-table-column prop="creatorTime" label="创建时间" sortable width="140"
            :formatter="jnpf.tableDateFormat" />
