    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" sortable='custom' size="mini"
          ...
          <el-table-column prop="startTime" label="开始日期/结束日期" sortable width="140">
            <template slot-scope="scope">
              <p>{{ scope.row.startTime | toDate("yyyy-MM-dd HH:mm:ss") }}</p>
              <p class="text-grey">{{scope.row.endTime | toDate("yyyy-MM-dd HH:mm:ss") }}</p>
            </template>
          </el-table-column>
