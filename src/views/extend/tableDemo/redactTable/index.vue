    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main  JNPF-flex-main">
        <div class="JNPF-common-head">
          <el-button type="primary" icon="el-icon-plus" @click="addOrUpdateHandle()">新建
          </el-button>
        ...
        <JNPF-table v-loading="listLoading" :data="list" @cell-click="tabClick">
          ...
          <el-table-column prop="interactionDate" label="交互时间" width="230">
            <template slot-scope="scope">
              <el-date-picker v-model="scope.row.interactionDate" type="date" :editable="false"
                :clearable="false" value-format="timestamp" format="yyyy-MM-dd HH:mm:ss"
                v-if="tabClickId==scope.row.id" />
              <span v-else>{{scope.row.interactionDate | toDate("yyyy-MM-dd HH:mm:ss")}}</span>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="registerDate" label="登记时间" :formatter="jnpf.tableDateFormat"
            width="140" />
