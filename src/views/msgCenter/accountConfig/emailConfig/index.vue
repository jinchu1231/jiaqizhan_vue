      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <topOpts @add="addOrUpdateHandle()">
            <!-- <upload-btn url="/api/message/AccountConfig/Actions/Import" @on-success="initData" /> -->
          </topOpts>
        ...
        <JNPF-table v-loading="listLoading" :data="list">
          ...
          <el-table-column prop="addressorName" label="发件人昵称" width="170" />
          <el-table-column prop="smtpUser" label="用户名" width="210" />
...
export default {
  name: 'msgCenter-accountConfig-mail',
  components: {
    Form
  },
  data() {
