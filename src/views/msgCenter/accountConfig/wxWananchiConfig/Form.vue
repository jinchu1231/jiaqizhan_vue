<template>
  <el-dialog :title="!dataForm.id ? '新建' : '编辑'" :close-on-click-modal="false"
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" v-loading="formLoading"
      ...
      <jnpf-form-tip-item label="Token" prop="agentId">
        <el-input v-model="dataForm.agentId" placeholder="请输入Token" clearable />
      </jnpf-form-tip-item>
      <jnpf-form-tip-item label="EncodingAESKey" prop="bearer">
        <el-input v-model="dataForm.bearer" placeholder="请输入EncodingAESKey" clearable />
      </jnpf-form-tip-item>
