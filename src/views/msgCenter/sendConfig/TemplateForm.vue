<template>
  <el-dialog :title="dataForm.id?'编辑':'新建'" :close-on-click-modal="false" :visible.sync="visible"
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="100px">
      ...
      <template
        v-if="dataForm.messageType!=1 && dataForm.messageType!=4 && dataForm.messageType!=5">
