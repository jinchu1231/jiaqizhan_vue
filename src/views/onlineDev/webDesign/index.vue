<template>
  <div class="JNPF-common-layout">
        ...
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="类型">
              <el-select v-model="webType" placeholder="请选择类型" clearable filterable>
          ...
          <template v-if="showAll">
            <el-col :span="6">
              <el-form-item label="状态">
                <el-select v-model="isRelease" placeholder="请选择状态" clearable filterable>
                  <el-option v-for="item in releaseOptions" :key="item.id" :label="item.fullName"
                    :value="item.id">
                  </el-option>
                </el-select>
              </el-form-item>
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <topOpts @add="openAddBox()">
            <upload-btn url="/api/visualdev/OnlineDev/Actions/Import" accept=".vdd"
              @on-success="initData" />
          </topOpts>
    ...
    <el-dialog title="同步菜单" :visible.sync="releaseDialogVisible"
      ...
      <el-alert title="将该功能的按钮、列表、表单及数据权限同步至应用菜单" type="warning" :closable="false" show-icon />
