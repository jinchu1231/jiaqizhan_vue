        ...
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="过期时间">
              <el-date-picker v-model="overdueTime" start-placeholder="开始时间" end-placeholder="结束时间"
                clearable value-format="timestamp" type="datetimerange"
  ...
  methods: {
    ...
    initData() {
      ...
      let listQuery = {
        ...
        overdueStartTime: this.overdueTime[0],
        overdueEndTime: this.overdueTime[1]
      }
      CacheManageList(listQuery).then(res => {
