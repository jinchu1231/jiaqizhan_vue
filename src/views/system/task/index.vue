    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list">
          ...
          <el-table-column prop="startTime" label="任务开始时间" width="140"
            :formatter="jnpf.tableDateFormat" />
          <el-table-column prop="endTime" label="任务结束时间" width="140"
            :formatter="jnpf.tableDateFormat" />
          <el-table-column prop="lastRunTime" label="最后执行时间" width="140"
            :formatter="jnpf.tableDateFormat" />
          <el-table-column prop="nextRunTime" label="下次运行时间" width="140"
            :formatter="jnpf.tableDateFormat" />
