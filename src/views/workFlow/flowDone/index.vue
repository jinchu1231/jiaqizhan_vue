        ...
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="分类">
              <el-select v-model="flowCategory" placeholder="请选择分类" clearable filterable>
          ...
          <template v-if="showAll">
            <el-col :span="6">
              <el-form-item label="所属流程">
                <el-select v-model="templateId" placeholder="请选择所属流程" clearable
            ...
            <el-col :span="6">
              <el-form-item label="所属名称">
                <el-select v-model="flowId" placeholder="请选择所属名称" clearable
            ...
            <el-col :span="6">
              <el-form-item label="发起人员">
                <JnpfUserSelect v-model="creatorUserId" placeholder="请选择发起人员" />
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="紧急程度">
                <el-select v-model="urgent" placeholder="请选择紧急程度" clearable filterable>
        ...
        <JNPF-table v-loading="listLoading" :data="list">
          ...
          <el-table-column prop="status" label="流程状态" width="130" align="center">
            <template slot-scope="scope">
              ...
              <el-tag type="warning" v-else-if="scope.row.status == 13">转向</el-tag>
              <el-tag type="danger" v-else>退回</el-tag>
            </template>
          </el-table-column>
          <el-table-column prop="creatorTime" label="办理时间" width="140"
            :formatter="jnpf.tableDateFormat" />
