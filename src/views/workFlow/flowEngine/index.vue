        ...
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="流程类型">
              <el-select v-model="type" placeholder="请选择流程类型" clearable filterable>
          ...
          <template v-if="showAll">
            <el-col :span="6">
              <el-form-item label="状态">
                <el-select v-model="enabledMark" placeholder="请选择状态">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <topOpts @add="dialogVisible=true">
            <upload-btn url="/api/workflow/Engine/flowTemplate/Actions/Import" accept=".ffe"
              @on-success="reset()" />
          </topOpts>
