  ...
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main">
      ...
      <div class="main">
          ...
          <el-form @submit.native.prevent>
            ...
            <el-col :span="6">
              <el-form-item label="所属流程">
                <el-select v-model="listQuery.templateId" placeholder="请选择所属流程" clearable
            ...
            <el-col :span="6">
              <el-form-item label="所属名称">
                <el-select v-model="listQuery.flowId" placeholder="请选择所属名称" clearable
            ...
            <template v-if="showAll">
              <el-col :span="6">
                <el-form-item label="所属节点">
                  <el-select v-model="listQuery.nodeCode" placeholder="请选择所属节点" clearable
              ...
              <el-col :span="6">
                <el-form-item label="发起时间">
                  <el-date-picker v-model="pickerVal" type="datetimerange" start-placeholder="开始时间"
                    end-placeholder="结束时间" :picker-options="pickerOptions" value-format="timestamp"
              ...
              <el-col :span="6">
                <el-form-item label="分类">
                  <el-select v-model="listQuery.flowCategory" placeholder="请选择分类" clearable
                    filterable>
              ...
              <el-col :span="6">
                <el-form-item label="发起人员">
                  <JnpfUserSelect v-model="listQuery.creatorUserId" placeholder="请选择发起人员" />
                </el-form-item>
              </el-col>
            </template>
            <el-col :span="6">
        ...
        <div class="alert">
          <el-alert title="请先选择所属流程、名称和节点。（同一流程同一节点的审批数据才能使用批量审批）" type="warning" :closable="false"
            show-icon />
        </div>
        ...
        <JNPF-table v-loading="listLoading" :data="list" has-c @selection-change="handleChange">
          ...
          <el-table-column prop="creatorTime" label="接收时间" :formatter="jnpf.tableDateFormat"
            width="140" />
        </JNPF-table>
