        ...
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="表单类型">
              <el-select v-model="query.formType" placeholder="请选择表单类型" clearable filterable>
          ...
          <el-col :span="6">
            <el-form-item label="状态">
              <el-select v-model="query.isRelease" placeholder="请选择状态">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <topOpts @add="dialogVisible=true">
            <upload-btn url="/api/flowForm/Form/Actions/Import" accept=".fff"
              @on-success="reset()" />
          </topOpts>
